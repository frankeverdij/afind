...
struct param_t { const char *name; void *addr; char type; };
...
*/
		case truncate: if (ofn) finder (fn).truncate (ofn); else fprintf (stderr, "%s", need_ofn); break;
